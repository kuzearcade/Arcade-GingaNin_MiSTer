# Ginga Ninkyouden timing constraints, from Arcade-JalecoMS1Z_MiSTer's
# JalecoMS1Z.sdc (same PLL, same clock plan).
#
...
# Core clock groups
# ------------------------------------------------------------------
# The game logic (68000, 6809, the sound chips, video) runs on clk_sys at 48 MHz and
...
# two-flop synchronisers, not a synchronous path (MS1Z, same PLL).
set core_pll_groups {}
